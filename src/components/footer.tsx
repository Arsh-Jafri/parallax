...
export function Footer() {
  const links = [
    { href: 'https://linkedin.com/in/arshjafri', icon: <LinkedInIcon />, label: 'LinkedIn' },
    { href: 'https://github.com/arsh-jafri',    icon: <GitHubIcon />,   label: 'GitHub' },
    { href: 'https://arshjafri.com',             icon: <GlobeIcon />,    label: 'arshjafri.com' },
  ];
